#!/usr/bin/env bash
# Mastercut for 2026-08-04-the-window-that-closed
#
...
ffmpeg -y -loglevel error -i "$WORK/video.mp4" -f lavfi -i anullsrc=r=48000:cl=stereo \
  -shortest -c:v copy -c:a aac -b:a 128k "2026-08-04-the-window-that-closed-mastercut.mp4"
rm -rf "$WORK"
echo "✓ 2026-08-04-the-window-that-closed-mastercut.mp4  — talk over this one."
